	...
	if ( ubQuest == nQuests.QUEST_RESCUE_MARIA ) then
		...
		if ( (CheckFact( Facts.FACT_MARIA_ESCAPE_NOTICED, 0 ) == false) and (CheckFact( Facts.FACT_KINGPIN_DEAD, 0 ) == false) and
			...
			if sector_silva == 1 then
				...
				SetProfileStrategicInsertionData(Profiles.MARIA, 12199)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 12359)
			elseif sector_silva == 2 then
				-- B5
				AddNPCtoSector (Profiles.MARIA,5,2,0) 
				AddNPCtoSector (Profiles.ANGEL,5,2,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 11946)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 12106)
			elseif sector_silva == 3 then
				-- B6
				AddNPCtoSector (Profiles.MARIA,6,2,0) 
				AddNPCtoSector (Profiles.ANGEL,6,2,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 17031)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 17191)
			elseif sector_silva == 4 then
				-- B8
				AddNPCtoSector (Profiles.MARIA,8,2,0) 
				AddNPCtoSector (Profiles.ANGEL,8,2,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 12243)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 12242)
			elseif sector_silva == 5 then
				-- B12
				AddNPCtoSector (Profiles.MARIA,12,2,0) 
				AddNPCtoSector (Profiles.ANGEL,12,2,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 14832)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 14994)
			elseif sector_silva == 6 then
				-- B14
				AddNPCtoSector (Profiles.MARIA,14,2,0) 
				AddNPCtoSector (Profiles.ANGEL,14,2,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 13473)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 13793)
			elseif sector_silva == 7 then
				-- C3
				AddNPCtoSector (Profiles.MARIA,3,3,0) 
				AddNPCtoSector (Profiles.ANGEL,3,3,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 10169)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 10330)
			elseif sector_silva == 8 then
				-- D7
				AddNPCtoSector (Profiles.MARIA,7,4,0) 
				AddNPCtoSector (Profiles.ANGEL,7,4,0)
				SetProfileStrategicInsertionData(Profiles.MARIA, 16752)
				SetProfileStrategicInsertionData(Profiles.ANGEL, 17232)
			end	
